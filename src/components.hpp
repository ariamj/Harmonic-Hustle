...
enum class TEXTURE_ASSET_ID {
	...
	HELD_NOTE_EXAMPLE_MID = HELD_NOTE_EXAMPLE_TAP + 1,
	HELD_NOTE_EXAMPLE_FINISH = HELD_NOTE_EXAMPLE_MID + 1,
	TEXTURE_COUNT = HELD_NOTE_EXAMPLE_FINISH +1 // keep as last variable
};
